...
cc.Class({
    ...
    start () {
        ...
        this.node.addComponent("ShiHuKa_Card").init(this.cardsAtlas);
        ...
        // this.node.addComponent("ShiHuKa_Menu");

        for(let i = 0; i < cc.vv.gameData.RoomSeat; ++i){
            this.node.addComponent("ShiHuKa_ShowCard").init(i,conf.seat);
            this.node.addComponent("ShiHuKa_Player").init(i,conf.seat,this.emjoAtlas);
            this.node.addComponent("ShiHuKa_OutCard").init(i,conf.seat);
            this.node.addComponent("ShiHuKa_OperatePai").init(i,conf.seat);
            this.node.addComponent("ShiHuKa_HandCard").init(i,conf.seat);
        }
        // this.node.addComponent("ShiHuKa_HandCard").init();
        this.node.addComponent("ShiHuKa_Operate");
        this.node.addComponent("ShiHuKa_Tips");
        this.node.addComponent("ShiHuKa_Action");
        this.node.addComponent("ShiHuKa_RemainCard");
        this.node.addComponent("ShiHuKa_RoundOver").init(this.tableAtlas);
        this.node.addComponent("ShiHuKa_GameOver").init(this.tableAtlas,this.yinxiAtlas);
        this.node.addComponent("ShiHuKa_Sound");
