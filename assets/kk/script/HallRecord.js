        ...
        if(msg.code === 200 && msg.data){
            for (var i = 0; i < msg.data.length; i++) {
                ...
                let gameIconStr = ["","penghu","paohuzi","penghu","paohuzi","hongheihu","hongheihu","liuhuqiang","liuhuqiang","paodekuai","paodekuai",
                                    "hongzhong","hongzhong","shihuka","shihuka","tonghua","tonghua","erqigui","erqigui","zhuanzhuan","zhuanzhuan"];
                ...
                for (var j = 0; j < playerData.length; j++) {
                    ...
                    if (0 <= playerData[j].score) {
                        if (0 == playerData[j].score) {
                            ...
                            playerInfoItem.getChildByName("text_score_win").getComponent(cc.Label).string = playerData[j].score.toFixed(2);
                        }
                        ...
                        playerInfoItem.getChildByName("text_score_lose").getComponent(cc.Label).string = '/' + Math.abs(playerData[j].score).toFixed(2);
                    }
            ...
            cc.find("todatConsume_node/text_todayConsumeCoin", this._gameRecordLayer).getComponent(cc.Label).string = "今日消耗金币：" + msg.costCoin;
