    ...
    onRcvGameRecord(msg){
        ...
        if(msg.code === 200 && msg.data){
            for (var i = 0; i < msg.data.length; i++) {
                ...
                let gameIconStr = ["","penghu","paohuzi","penghu","paohuzi","hongheihu","hongheihu","liuhuqiang","liuhuqiang","paodekuai","paodekuai","hongzhong","hongzhong","erqigui","erqigui"];
                ...
                let gameNameStr = ["","碰胡","跑胡子","碰胡","跑胡子","红黑胡","红黑胡","六胡抢","六胡抢","跑得快","跑得快","红中","红中","二七鬼","二七鬼"];
