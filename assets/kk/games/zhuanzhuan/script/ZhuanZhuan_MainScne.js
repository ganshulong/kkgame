...
cc.Class({
    ...
    start () {
        ...
        this.node.addComponent("ZhuanZhuan_Card").init();

        for(let i = 0; i < cc.vv.gameData.RoomSeat; ++i){
            // this.node.addComponent("ZhuanZhuan_ShowCard").init(i,conf.seat);
            this.node.addComponent("ZhuanZhuan_Player").init(i,conf.seat,this.emjoAtlas);
            this.node.addComponent("ZhuanZhuan_OutCard").init(i,conf.seat);
            this.node.addComponent("ZhuanZhuan_HandCard").init(i,conf.seat);
        }
        this.node.addComponent("ZhuanZhuan_Operate");
        this.node.addComponent("ZhuanZhuan_Tips");
        this.node.addComponent("ZhuanZhuan_Action");
        // this.node.addComponent("ZhuanZhuan_RemainCard");
        this.node.addComponent("ZhuanZhuan_RoundOver").init(this.tableAtlas);
        this.node.addComponent("ZhuanZhuan_GameOver").init(this.tableAtlas,this.yinxiAtlas);
        this.node.addComponent("ZhuanZhuan_Sound");
        this.node.addComponent("ZhuanZhuan_Chat");
        this.node.addComponent("ZhuanZhuan_Setting");
