...
cc.Class({
    ...
    showCard(cardValue){
        ...
        let node = this.node.getComponent("ShiHuKa_Card").createCard(cardValue,0,cardValue==0?true:false,this._showCardNode);
        ...
        if(this._cardValue){
            ...
            if(data.actionInfo.curaction.seat === this._seatIndex){
                ...
                if(data.actionInfo.curaction.type === cc.vv.gameData.OPERATETYPE.PUT){
                    ...
                    this.node.getComponent("ShiHuKa_Card").changCardBg(this._showCardNode.getChildByName("card_light"),false);
    ...
    recvMoPaiNotify(data){
        ...
        if(data.seat === this._seatIndex){
           this.showCard(data.card);
            ...
            this.node.getComponent("ShiHuKa_Card").changCardBg(this._showCardNode.getChildByName("card_light"),true);
            ...
            if(deskInfo.smallState === 1){
                if(deskInfo.actionInfo.curaction.type === cc.vv.gameData.OPERATETYPE.PUT ||
                    ...
                    if (deskInfo.actionInfo.curaction.seat === this._seatIndex) {
                        ...
                        this.node.getComponent("ShiHuKa_Card").changCardBg(this._showCardNode.getChildByName("card_light"),
