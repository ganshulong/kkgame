...
"./cocos2d/core/platform/CCEnum": 106
} ],
3: [ (function(t, e, i) {}), {} ],
4: [ (function(i, n, o) {
function r(t, e) {
...
for (var S, A, x = f.ratios, O = !0, N = 1, I = x.length; N < I; N++) {
S = x[N] - x[N - 1];
if (1 === N) A = S; else if (Math.abs(S - A) > 1e-6) {
O = !1;
break;
}
}
f._findFrameIndex = O ? h : p;
return f;
}
function s(t, e) {
...
var S, A = C[E], x = A.frame / n.duration, O = p(T.ratios, x);
if (O >= 0) S = T.events[O]; else {
S = new f();
T.ratios.push(x);
T.events.push(S);
}
...
function r(t, e) {
var i = (function(t, e) {
var i, n, r, u, d = e - 0, f = e - t[0], _ = 3 * d, p = 3 * f, g = 3 * (e - t[2]), v = 1 / (-d + p - g + (e - 1)), m = (_ - 6 * f + g) * v, y = m * (1 / 3), C = (-_ + p) * v, T = 1 / 3 * (3 * C - m * m), E = T * (1 / 3), b = (2 * m * m * m - 9 * m * C + d * v * 27) / 27, S = b / 2, A = S * S + E * E * E;
if (A < 0) {
var x = 1 / 3 * -T, O = h(x * x * x), N = -b / (2 * O), I = c(N < -1 ? -1 : N > 1 ? 1 : N), w = 2 * o(O);
n = w * s(I * (1 / 3)) - y;
r = w * s((I + l) * (1 / 3)) - y;
u = w * s((I + 2 * l) * (1 / 3)) - y;
...
var T, E = t[y], b = f[y], S = f[y + 1] - b, A = u[y], x = u[y + 1], O = d[y], N = [], I = v / S, w = 1 / (S * i * o);
if (E && E.length > 0) {
var L = [];
L.push(r(A));
...
var B, z, j, k;
if ((T = c(T = I, O)) < 0) {
k = (0 - T) * (z = F.beziers[0]).getLength();
j = z.start.sub(z.endCtrlPoint).normalize();
B = z.start.add(j.mul(k));
} else if (T > 1) {
k = (T - 1) * (z = F.beziers[F.beziers.length - 1]).getLength();
...
var s = i("./utils/prefab-helper"), c = i("./utils/scene-graph-helper"), a = i("./event-manager"), l = cc.Object.Flags, h = l.Destroying, u = "position-changed", d = "size-changed", f = "anchor-changed", _ = "rotation-changed", p = "scale-changed", g = i("./utils/misc"), v = i("./event/event"), m = !!cc.ActionManager, y = function() {}, C = cc.Enum({
...
}), T = [ C.TOUCH_START, C.TOUCH_MOVE, C.TOUCH_END, C.TOUCH_CANCEL ], E = [ C.MOUSE_DOWN, C.MOUSE_ENTER, C.MOUSE_MOVE, C.MOUSE_LEAVE, C.MOUSE_UP, C.MOUSE_WHEEL ], b = null, S = function(t, e) {
...
m && cc.director.getActionManager().pauseTarget(this);
a.pauseTarget(this);
}
};
...
m && cc.director.getActionManager().removeAllActionsFromTarget(this);
b === this && (b = null);
...
-1 !== T.indexOf(t) ? this._checkTouchListeners() : -1 !== E.indexOf(t) && this._checkMouseListeners();
},
...
"./utils/base-node": 125,
"./utils/misc": 129,
"./utils/prefab-helper": 131,
"./utils/scene-graph-helper": 132
} ],
17: [ (function(t, e, i) {
cc.Scene = cc.Class({
name: "cc.Scene",
...
var S = e._isAbsHorizontalCenter ? e._horizontalCenter : e._horizontalCenter * C, A = (.5 - f.x) * a.width;
if (c) {
S *= s.x;
A += r.x;
A *= s.x;
...
var x, O, N = a.height;
if (_) {
O = cc.visibleRect.bottom.y;
x = cc.visibleRect.top.y;
} else x = (O = -f.y * N) + N;
O += e._isAbsBottom ? e._bottom : e._bottom * N;
x -= e._isAbsTop ? e._top : e._top * N;
if (c) {
O += r.y;
O *= s.y;
x += r.y;
...
g = P + (w - .5) * I + R;
} else g = e.isAlignBottom ? O + w * I : x + (w - 1) * I;
}
}
t.setPosition(p, g);
}
...
var E = h * (1 - T) * l.width;
if (e) {
var b = f + E + h * (h > 0 ? this.paddingRight : this.paddingLeft), S = this.horizontalDirection === c.LEFT_TO_RIGHT && b > (1 - a.x) * t, A = this.horizontalDirection === c.RIGHT_TO_LEFT && b < -a.x * t;
if (S || A) {
if (l.height >= p) {
0 === g && (g = p);
_ += g;
...
var O, N = 1, I = 0 === p ? l.height : p;
if (this.verticalDirection === s.TOP_TO_BOTTOM) {
m = m || this.node._contentSize.height;
(O = x + (N = -1) * (I * y + this.paddingBottom)) < m && (m = O);
} else {
m = m || -this.node._contentSize.height;
(O = x + N * (I * y + this.paddingTop)) > m && (m = O);
}
f += E;
}
}.bind(this));
...
if (e) {
var b = f + E + h * (h > 0 ? this.paddingTop : this.paddingBottom), S = this.verticalDirection === s.BOTTOM_TO_TOP && b > (1 - a.y) * t, A = this.verticalDirection === s.TOP_TO_BOTTOM && b < -a.y * t;
if (S || A) {
if (l.width >= p) {
0 === g && (g = p);
_ += g;
...
var O, N = 1, I = 0 === p ? l.width : p;
if (this.horizontalDirection === c.RIGHT_TO_LEFT) {
N = -1;
m = m || this.node._contentSize.width;
(O = x + N * (I * y + this.paddingLeft)) < m && (m = O);
} else {
m = m || -this.node._contentSize.width;
(O = x + N * (I * y + this.paddingRight)) > m && (m = O);
}
f += E;
}
}.bind(this));
...
"../label/CCHtmlTextParser": 84,
"../label/CCTextUtils": 85
} ],
59: [ (function(t, e, i) {
...
"../platform/callbacks-invoker": 112
} ],
76: [ (function(i, n, o) {
function r() {
...
var c = i("../platform/js"), a = i("./pipeline"), l = i("./loading-items"), h = i("./asset-loader"), u = i("./downloader"), d = i("./loader"), f = i("./asset-table"), _ = i("../platform/utils").callInNextTick, p = i("./auto-release-utils"), g = new f(), v = [ "mp3", "ogg", "wav", "m4a" ], m = {
url: null,
raw: !1
}, y = [], C = [];
c.extend(s, a);
...
} else t instanceof cc.Texture2D ? cc.textureCache.removeTextureForKey(o.rawUrl || o.url) : -1 !== v.indexOf(o.type) && cc.audioEngine.uncache(o.rawUrl || o.url);
0;
}
}
};
...
var d = i[h];
A.validateMethodWithProps(d, h, n, s, o) && y.value(s.prototype, h, d, !0, !0);
}
var f = i.editor;
...
T.cloneable_DEV, i("./attribute")), b = E.DELIMETER, S = E.getTypeChecker, A = i("./preprocess-class");
i("./requiring-frame");
var x = [ "name", "extends", "mixins", "ctor", "__ctor__", "properties", "statics", "editor", "__ES6__" ], O = {
datas: null,
push: function(t) {
...
}, N = [], I = /^[$A-Za-z_][0-9A-Za-z_$]*$/, w = function(t, e, i, n) {
...
return cc.Class(n);
})), T = f(c), E = d(v, "requireComponent"), b = f(m), S = d(y, "executionOrder"), A = f(c), x = f(c), O = f(m), N = f(m), I = f(m);
...
var x = T.toDataURL("image/webp").startsWith("data:image/webp"), O = !!T.getContext("2d"), N = !1;
...
if (m) {
var x, O = p[T + o];
if (void 0 === A && O) x = O === cc.String || O === cc.Integer || O === cc.Float || O === cc.Boolean; else {
var N = "object" == (e = typeof A) ? t(A) : e;
x = "string" === N && !p[T + f] || "number" === N || "boolean" === N;
}
x ? v.push("o" + E + "=prop;") : l(v, A, E, C, !0);
} else {
...
this.codeArray.push(b + S + "," + A + ";", "if(R){", S + "=R;", "}else{", S + "=R=new " + this.getFuncModule(t.constructor, !0) + "();", "}");
t._iN$t = {
globalVar: "R"
};
...
var d = i("./CCObject"), f = d.Flags.Destroyed, _ = d.Flags.PersistentMask, p = i("./attribute"), g = i("./js"), v = i("./CCClass"), m = i("./compiler"), y = p.DELIMETER + "serializable", C = p.DELIMETER + "default", T = v.IDENTIFIER_RE, E = v.escapeForJS, b = "var ", S = "o", A = "t", x = {
"cc.Node": "cc.Node",
"cc.Sprite": "cc.Sprite",
"cc.Label": "cc.Label",
"cc.Button": "cc.Button",
...
O.setValueType = function(t, e, i, n) {
...
O.enumerateCCClass = function(i, n, o) {
...
O.enumerateField = function(i, n, o) {
...
O.setObjProp = function(t, e, i, n) {
c(t, S + h(i) + "=", this.enumerateField(e, i, n));
};
O.enumerateObject = function(i, n) {
var o = n.constructor;
...
"../utils/mutable-forward-iterator": 130,
"./id-generater": 115
} ],
120: [ (function(i, n, o) {
function r(t, e, i, n) {
...
"./CCAffineTransform": 133,
"./CCColor": 134,
"./CCPointExtension": 135,
"./CCRect": 136,
"./CCSize": 137,
"./CCTypes": 138,
"./CCTypesWebGL": 139,
...
"./cocos2d/deprecated": 143,
"./cocos2d/motion-streak/CCMotionStreak": 1,
"./cocos2d/particle/CCParticleAsset": 144,
"./cocos2d/particle/CCParticleSystem": 145,
"./cocos2d/tilemap/CCTiledMap": 1,
"./cocos2d/tilemap/CCTiledMapAsset": 1,
"./extensions/ccpool/CCNodePool": 147,
"./extensions/ccpool/CCPool": 148,
"./extensions/dragonbones": 152,
"./extensions/spine": 155,
...
"./CCSlot": 1,
"./CCTextureData": 1,
"./DragonBonesAsset": 150,
"./DragonBonesAtlasAsset": 151,
"./lib/dragonBones": 1
} ],
153: [ (function(i, n, o) {
var r = cc.Enum({
...
"../CCDebugger": 2,
"../DebugInfos": 3,
"../cocos2d/core/event": 78,
"../cocos2d/core/event-manager/CCEvent": 73,
"../cocos2d/core/platform/CCMacro": 107,
"../cocos2d/core/platform/js": 119,
"../cocos2d/core/utils/find": 128,
"../cocos2d/core/utils/mutable-forward-iterator": 130,
"../cocos2d/core/value-types": 142,
"../extends": 146,
"../polyfill/misc": 174,
"../polyfill/string": 175,
...
"../cocos2d/core/event/event-listeners": 75,
"../cocos2d/core/load-pipeline/auto-release-utils": 89,
"../cocos2d/core/node-activator": 102
} ],
160: [ (function(t, e, i) {
...
"../cocos2d/core/platform/CCClass": 104
} ],
172: [ (function(t, e, i) {
"use strict";
if (!cc.runtime) {
